<?php /* Smarty version Smarty-3.1.19, created on 2017-04-29 14:46:14
         compiled from "/var/www/html/themes/default-bootstrap/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:155074956759048b16710535-39400203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0432b7a014401b5146e8fd1026b58b6aedb2580' => 
    array (
      0 => '/var/www/html/themes/default-bootstrap/addresses.tpl',
      1 => 1493117697,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '155074956759048b16710535-39400203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59048b1683ad69_02925935',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59048b1683ad69_02925935')) {function content_59048b1683ad69_02925935($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php $_tmp24=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp24), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
                <a class="btn btn-default button button-small" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
<?php $_tmp25=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp25."&delete"), ENT_QUOTES, 'UTF-8', true);?>
